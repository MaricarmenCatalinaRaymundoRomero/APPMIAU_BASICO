                  ...
                  <IonCard>
                    <IonCardContent>
                      <form onSubmit={doLogin}>
                        <IonInput mode="md" fill="outline" labelPlacement="floating" label="Email" type="email" placeholder="Maricarmen@cat.com"></IonInput>
                        ...
                        <IonButton routerLink="/register" color={'danger'} type="button" expand="block" className="ion-margin-top">
                        𝐑𝐞𝐠𝐢𝐬𝐭𝐫𝐚𝐫𝐬𝐞
